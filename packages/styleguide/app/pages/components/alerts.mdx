...
const ComponentWithAlerts = () => {
  ...
  return (
    <button onClick={() => show({ text: 'I am an alert' })}>Show alert when clicked!</button>
  );
};
```
...
const ComponentWithAlerts = () => {
  ...
  return (
    <div>
      <button onClick={() => show({ text: 'I am an alert', id: 'my-alert' })}>Show alert when clicked!</button>
      <button onClick={() => hide('my-alert')}>Hide alert!</button>
    </div>
  );
};
```
    ...
    <Flex justify={FlexJustify.START}>
      <FlexItem>
        <Margin size={{ right: Sizes.SMALL }}>
          <Button category={Categories.SUCCESS} onClick={() => show({ category: Categories.SUCCESS, text: 'Congrats you did it!', id: 'success' })}>
            Show success
          </Button>
        </Margin>
      </FlexItem>
      <FlexItem>
        <Margin size={{ right: Sizes.SMALL }}>
          <Button category={Categories.DANGER} onClick={() => show({ category: Categories.DANGER, text: 'Oh oh! Something went bad.', id: 'danger' })}>
            Show danger
          </Button>
        </Margin>
      </FlexItem>
      <FlexItem>
        <Margin size={{ right: Sizes.SMALL }}>
          <Button category={Categories.WARNING} onClick={() => show({ category: Categories.WARNING, text: 'Oh oh! Careful there.', id: 'warning' })}>
            Show warning
          </Button>
        </Margin>
      </FlexItem>
      <FlexItem>
        <Button category={Categories.INFO} onClick={() => show({ category: Categories.INFO, text: 'Here is some info. You are welcome.', id: 'info' })}>
          Show info
        </Button>
      </FlexItem>
    </Flex>

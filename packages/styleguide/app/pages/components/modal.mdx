...
If you want to easily change parts of the modal, you can remove either of these parts to make your modal simpler: `Drylus-Modal__title`, `Drylus-Modal__content`, `Drylus-Modal__footer`.

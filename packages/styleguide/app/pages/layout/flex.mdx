...
```jsx
import { Flex, FlexItem, FlexAlign, FlexJustify, FlexDirections } from '@drawbotics/react-drylus';
```
...
<Playground component={Flex} enums={{ FlexAlign, FlexDirections, FlexJustify }}>

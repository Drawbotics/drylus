...
<Playground>
  <Flex>
    <FlexItem>
      <AnimatedItem speed={Speed.FAST} width="100%"><Item /></AnimatedItem>
    </FlexItem>
    <FlexSpacer size={Size.DEFAULT} />
    <FlexItem>
      <AnimatedItem width="100%"><Item /></AnimatedItem>
    </FlexItem>
    <FlexSpacer size={Size.DEFAULT} />
    <FlexItem>
      <AnimatedItem speed={Speed.SLOW} width="100%"><Item /></AnimatedItem>
    </FlexItem>
  </Flex>
</Playground>

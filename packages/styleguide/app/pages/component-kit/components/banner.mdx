...
# Banner
Component used to display an important message that should take precedence over the rest of the content of the page. Similar to [`Callout`](/component-kit/components/callout), but used to the inform the user of possible actions he needs to make, or as a result of an _uncontrolled_ effect. Cannot be dismissed.
...
<Playground component={Banner}>
  <Banner title="You don't have enough credits" category={Category.DANGER}>
